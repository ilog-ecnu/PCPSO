function Population = WOF_optimiseByNSGAII(GlobalDummy, Population, evaluations, isDummy,Problem)
% ----------------------------------------------------------------------- 
    ...
    while currentEvaluations(GlobalDummy, isDummy) < maximum
        ...
        if isDummy == true
            ...
            for j = 1:numberOfNewSolutions
                Offspring   = [Offspring, WOF_WeightIndividual(NewDec,GlobalDummy,Problem)];
            end
        else
